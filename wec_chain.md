# Welcome to the WEC Chain Wiki!

<!-- ![](logo.png) -->

> WEC wiki covering all things related to Web Coin Pay technologies

This is the wiki covering all sorts of information on the next-generation peer-to-peer technology platform built by the Web Coin Pay team.

**Contents**

- [Welcome to the WEC Chain Wiki!](#welcome-to-the-wec-chain-wiki)
- [Blockchain](#blockchain)
  - [Components](#components)
    - [Logical architecture diagram](#logical-architecture-diagram)
    - [WEC Chain Node](#wec-chain-node)
    - [Privacy Manager](#privacy-manager)
      - [Transaction Manager](#transaction-manager)
      - [The Enclave](#the-enclave)
  - [Design](#design)
    - [Public/Private State](#publicprivate-state)
...
# Blockchain
WEC blockchain based on Quorum, an Ethereum-based distributed technology, entire documentation of Ethereum blockchain [placed here](ethereum/Home.md).

WEC Chain is an Ethereum-based distributed ledger protocol that has been developed to provide industries such as finance, supply chain, retail, real estate, etc. with a permissioned implementation of Ethereum that supports transaction and contract privacy.  

WEC Chain includes a minimalistic fork of the [Go Ethereum client](https://github.com/ethereum/go-ethereum) (a.k.a geth), and as such, leverages the work that the Ethereum developer community has undertaken.  
 
The primary features of WEC Chain, and therefore extensions over public Ethereum, are:
...
![](quorum/Quorum%20Design.png)

### WEC Chain Node
The WEC Chain Node is intentionally designed to be a lightweight fork of geth in order that it can continue to take advantage of the R&D that is taking place within the ever growing Ethereum community.  To that end, WEC Chain will be updated in-line with future geth releases.

The WEC Chain Node includes the following modifications to geth:
...
For further details on the Enclave, please refer [here](quorum/Privacy/Tessera/Tessera%20Services/Enclave).

## Design
### Public/Private State

WEC Chain supports dual state:
...
Geth has pub/sub support. [Read this page](https://geth.ethereum.org/docs/rpc/server) for more information.

Open Ethereum has pub/sub support. [Read this](https://github.com/openethereum/openethereum) for more information.

Hyperledger Besu has pub/sub support. [Read this](https://besu.hyperledger.org/en/stable/Reference/API-Methods/) for more information.
